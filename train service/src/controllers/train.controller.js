...
async function getTrainById(req,res){
    ...
    try{
        ...
        const result=
        await trainService.getTrainById(
            req.params.id
        );
...
module.exports = { createTrain, getAllTrains ,searchTrains,initializeInventory,bookTicket,getMyBookings,cancelTicket,getAvailableSeats,getTrainById};